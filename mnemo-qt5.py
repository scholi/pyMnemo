...
from PyQt5.QtWidgets import QVBoxLayout, QLabel, QScrollArea, QInputDialog
from PyQt5.QtWidgets import QProgressBar, QFrame, QLineEdit, QPushButton
from PyQt5.QtCore import QObject, pyqtSignal, Qt

langs = {
    'French': dict(
        db='Lexique380.db',
        query="select ortho from lexique where cgram='NOM' and mnemo=? order by ortho;",
